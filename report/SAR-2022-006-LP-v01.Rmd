...
tab_inf %>%
    as_kable(
    caption = "**Tabela 2** Prevalência de complicações em idosos com 70 anos ou mais. Estimativa crua e estimativa ajustada por sexo, HAS, ASA, DM e hábitos tabagistas."
  )
```
...
(`r format.pct(est_adj-1, digits = 0)`)
